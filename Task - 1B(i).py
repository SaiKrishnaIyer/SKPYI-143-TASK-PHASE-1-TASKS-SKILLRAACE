...
if __name__ == "__main__":
    book = Book("Sample Book", "Author Name", "Publisher Name", 500)
    ebook = Ebook("Sample EBook", "Author Name", "Publisher Name", 500, "EPUB")

    # Calculate royalty for book
    print(f"Royalty for book (1000 copies sold): {book.royalty(1000)}")

    # Calculate royalty for ebook
    print(f"Royalty for ebook (1000 copies sold): {ebook.royalty(1000)}")
